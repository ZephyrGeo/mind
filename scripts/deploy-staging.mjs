...
const envFlag = gcloudDictionary([
  ...
  `MIND_CHAT_DAILY_LIMIT=${process.env.MIND_CHAT_DAILY_LIMIT ?? "30"}`,
  `MIND_RESEARCH_DAILY_LIMIT=${process.env.MIND_RESEARCH_DAILY_LIMIT ?? "2"}`,
  `MIND_RESEARCH_MAX_ACTIVE_PER_USER=${process.env.MIND_RESEARCH_MAX_ACTIVE_PER_USER ?? "1"}`,
